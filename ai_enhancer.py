...
def process_admin_conversational_assistant(
    ...
    prompt_text = (
        ...
        "'log in', or hasn't set this up yet, tell them conversationally to run "
        "`/userbotlogin +theirphone` and then `/userbotverify <code>` themselves. Do NOT emit an ACTION for this.\n"
        "- Guide the natural workflow: /userbotlogin+/userbotverify (once) -> listchannels -> analyzechannel "
        "-> previewtiming -> backfill or timedbackfill.\n"
